...
public class JpaUsersDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (usuario == null){
            logger.error("Login Error: "+username+" no existe");
            throw new UsernameNotFoundException("Login Error: "+username+" no existe");
        }
        ...
        if(authorities.isEmpty()){
            logger.error("Login Error: "+username+" no tiene roles asignados");
            throw new UsernameNotFoundException("Login Error: "+username+" no tiene roles asignados");
        }
